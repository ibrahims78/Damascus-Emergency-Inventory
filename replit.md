...
- `pnpm run build:android:offline` — build the Android v2.0.0 APK with the local IndexedDB offline API
...
- Release artifacts and checksums are stored under `releases/android/v2.0.0/`.
